...
from app.domains.gateway.services.impl.data_insert_service import DataInsertService
from app.domains.gateway.schemas.insert_payload import InsertPayload
